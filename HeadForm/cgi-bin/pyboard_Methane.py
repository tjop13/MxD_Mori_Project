...
def PyBoardData():
    ...
    message = '''
        ...
        <form method="POST" action="./pyboard_Methane.py">
...
#------------------------------Tag button--------------------------
            if form.has_key('Location'):
                if form.getfirst('Location','') == "Osaka":
                    Tag = "LocationID='Osaka'"
                elif form.getfirst('Location','') == "Kyoto":
                    Tag = "LocationID='Kyoto'"
                elif form.getfirst('Location','') == "Shiga":
                    Tag = "LocationID='Shiga'"
                else:
                    Tag = ""
