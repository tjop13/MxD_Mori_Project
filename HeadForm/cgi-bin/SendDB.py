...
cur.close()
    ...
    try:
        ...
        for each in cur.fetchall():
            print each['ID'],'$&',each['Genre'],'$&',each['LocationID'],'$&',['Genre'].encode('utf-8'),'$&',['regdate'].encode('utf-8'),'$&',each['name'].encode('utf-8'),'$&',each['comment'].encode('utf-8'),'$&',each['Replyname'].encode('utf-8'),'$&',each['Replycomment'].encode('utf-8'),'$& '
